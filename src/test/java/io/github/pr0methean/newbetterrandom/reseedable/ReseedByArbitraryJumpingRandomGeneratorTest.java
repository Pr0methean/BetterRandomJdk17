...
public class ReseedByArbitraryJumpingRandomGeneratorTest extends ReseedableRandomGeneratorTest {
  ...
  public static void findFactory() {
    Optional<RandomGeneratorFactory<RandomGenerator>> generator
        ...
        .findFirst();
    assumeTrue(generator.isPresent(), "No ArbitrarilyJumpableGenerator factory found");
