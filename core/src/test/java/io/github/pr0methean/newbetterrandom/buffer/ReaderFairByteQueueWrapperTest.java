...
public class ReaderFairByteQueueWrapperTest extends ByteQueueTest {
  @Override
  protected ByteQueue createBuffer(int size) {
    return new ReaderFairByteQueueWrapper(new AtomicByteRingBufferUsingByteBuffer(size), 16, 2);
  }
